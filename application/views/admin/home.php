...
<head>
  ...
  <title>Seleksi Animedia | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b></b> Animedia</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
              ...
              <li><a href="<?php echo base_url()?>KelolaBidang"><i class="fa fa-circle-o"></i> Kelola Data Bidang</a></li>
              <li><a href="<?php echo base_url()?>KelolaSoal"><i class="fa fa-circle-o"></i> Kelola Data Soal</a></li>
...
?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018</strong> | Desta. All rights
    reserved.
  </footer>
